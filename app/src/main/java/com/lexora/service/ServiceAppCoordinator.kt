...
import com.lexora.service.feature.organization.BranchDraft
import com.lexora.service.feature.organization.EmployeeDraft
import com.lexora.service.feature.requests.RequestDraft
...
internal class ServiceAppCoordinator(
    ...
    suspend fun clients(organizationId: String) = ClientState(
    ...
    suspend fun saveClient(organizationId: String, userId: String, draft: ClientDraft, existingId: String?) {
        val now = System.currentTimeMillis()
    ...
    suspend fun vehicles(organizationId: String) = VehicleState(
    ...
    suspend fun saveVehicle(organizationId: String, userId: String, draft: VehicleDraft, existingId: String?) {
        val now = System.currentTimeMillis()
        val id = existingId ?: UUID.randomUUID().toString()
    ...
    suspend fun assets(organizationId: String) = AssetState(
    ...
    suspend fun saveServiceObject(organizationId: String, userId: String, draft: ServiceObjectDraft, existingId: String?) {
    ...
    suspend fun saveEquipment(organizationId: String, userId: String, draft: EquipmentDraft, existingId: String?) {
    ...
    suspend fun organization(organizationId: String) = OrganizationState(
    ...
    suspend fun saveBranch(organizationId: String, userId: String, draft: BranchDraft, existingId: String?) {
    ...
    suspend fun saveEmployee(organizationId: String, userId: String, draft: EmployeeDraft, existingId: String?) {
    ...
    suspend fun requests(organizationId: String): List<ServiceRequest> = dao.serviceRequests(organizationId).map(ServiceRequestEntity::toModel)

    suspend fun saveRequest(organizationId: String, userId: String, draft: RequestDraft, existingId: String?) {
    ...
    suspend fun visits(organizationId: String, selectedVisitId: String?): VisitState {
        ...
        return VisitState(visits, selected, selected?.let { checklist(it) }.orEmpty())
    }

    suspend fun checklist(visitId: String): List<VisitChecklistItem> = dao.visitChecklist(visitId).map(VisitChecklistItemEntity::toModel)
    ...
    suspend fun finance(organizationId: String) = FinanceState(
