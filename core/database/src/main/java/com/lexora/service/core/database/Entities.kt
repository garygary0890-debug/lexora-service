...
@Entity(tableName = "branches", indices = [Index("organizationId")])
...
@Entity(tableName = "employees", indices = [Index("organizationId"), Index("branchId")])
...
@Entity(tableName = "module_settings", primaryKeys = ["organizationId", "moduleId"])
data class ModuleSettingEntity(
    val organizationId: String,
    val moduleId: String,
    val enabled: Boolean,
...
@Entity(tableName = "audit_events", indices = [Index("organizationId"), Index("entityId"), Index("occurredAtEpochMs")])
